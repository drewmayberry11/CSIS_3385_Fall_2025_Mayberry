...
Date: 2025-10-10
Course: CSIS-3385 — Database & Web Vulnerabilities (Competency 3, Project 2)
...
def get_users():
    return jsonify(users), 200  # Success
...
def delete_user(user_id):
    ...
    return jsonify({"message": f"User {user_id} deleted"}), 200  # Success
